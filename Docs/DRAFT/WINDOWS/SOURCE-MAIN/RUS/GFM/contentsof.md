...
В данный админ-пак входят следующие скрипты, файлы и утилиты:
  ...
  - **adAdminDomain.cmd**  
    файл создания учётной записи MyAdminAccount с паролем и наделение её
  ...
  - **datetimemsec.exe**  
    ...
    строк
  - **deAdminDomain.cmd**  
    файл удаления учётной записи MyAdminAccount с паролем и наделение её
    правами локального администратора компьютера
  - **deAdminLocal.cmd**  
    файл удаления учётной записи MyAdminAccount с паролем и наделение её
    правами локального администратора компьютера
  ...
  - **winlogon-SpecialAccounts.reg**  
    регистрация аккаунта MyAdminAccount как специального  
