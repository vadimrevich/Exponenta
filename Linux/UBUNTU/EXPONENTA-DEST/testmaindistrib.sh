...
#
echo "Coping file(s)..."
cp ./Exponenta1-Main-Install.tar.gz /opt/.tmp/.Exponenta1

# Load Main Files
echo "Loading Exponenta1-Main-Install.tar.gz..."
cd $LocalFolder
# curl $Host/Exponenta1-Main-Install.tar.gz -o Exponenta1-Main-Install.tar.gz

# Extract Installation Files
#
echo "Extracting Installation Files..."
tar  -C $LocalFolder -xzvf $LocalFolder/Exponenta1-Main-Install.tar.gz
if [ $? -ne 0 ]
then
...
mkdir -p $Exponenta1/Distrib/plugins
echo "Moving Files..."
mv $LocalFolder/InstallMainExponenta.sh $Exponenta1/Distrib/plugins/
mv $LocalFolder/loadmainupdate.sh $Exponenta1/Distrib/plugins/
# mv $LocalFolder/loadhttpmaindistrib.sh $Exponenta1/Distrib/plugins/
mv $LocalFolder/mainupdate.variables.sh $Exponenta1/Distrib/plugins/

echo "Updating Installation..."
$Exponenta1/Distrib/plugins/loadmainupdate.sh
